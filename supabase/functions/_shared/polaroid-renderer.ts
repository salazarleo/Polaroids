...
const FONT_CONFIG: Record<string, FontConfig> = {
  ...
  allura: {
    ...
    google: "Allura",
    fallback: "cursive",
    ttfUrl: `${GF}/ofl/allura/Allura-Regular.ttf`,
    widthFactor: 0.46,
  },
  parisienne: {
    family: "Parisienne",
    google: "Parisienne",
    fallback: "cursive",
    ttfUrl: `${GF}/ofl/parisienne/Parisienne-Regular.ttf`,
    widthFactor: 0.48,
  },
  "great-vibes": {
    family: "Great Vibes",
    google: "Great+Vibes",
    fallback: "cursive",
    ttfUrl: `${GF}/ofl/greatvibes/GreatVibes-Regular.ttf`,
    widthFactor: 0.5,
  },
  sacramento: {
    family: "Sacramento",
    google: "Sacramento",
    fallback: "cursive",
    ttfUrl: `${GF}/ofl/sacramento/Sacramento-Regular.ttf`,
    widthFactor: 0.45,
  },
  "alex-brush": {
    family: "Alex Brush",
    google: "Alex+Brush",
    fallback: "cursive",
    ttfUrl: `${GF}/ofl/alexbrush/AlexBrush-Regular.ttf`,
    widthFactor: 0.46,
  },
  "rouge-script": {
    family: "Rouge Script",
    google: "Rouge+Script",
    fallback: "cursive",
    ttfUrl: `${GF}/ofl/rougescript/RougeScript-Regular.ttf`,
    widthFactor: 0.45,
  },
  italianno: {
    family: "Italianno",
    google: "Italianno",
    fallback: "cursive",
    ttfUrl: `${GF}/ofl/italianno/Italianno-Regular.ttf`,
    widthFactor: 0.42,
  },
  tangerine: {
    family: "Tangerine",
    google: "Tangerine",
    fallback: "cursive",
    ttfUrl: `${GF}/ofl/tangerine/Tangerine-Regular.ttf`,
    widthFactor: 0.42,
  },
  "petit-formal-script": {
    family: "Petit Formal Script",
    google: "Petit+Formal+Script",
    fallback: "cursive",
    ttfUrl: `${GF}/ofl/petitformalscript/PetitFormalScript-Regular.ttf`,
    widthFactor: 0.5,
  },
  "mrs-saint-delafield": {
    family: "Mrs Saint Delafield",
    google: "Mrs+Saint+Delafield",
    fallback: "cursive",
    ttfUrl: `${GF}/ofl/mrssaintdelafield/MrsSaintDelafield-Regular.ttf`,
    widthFactor: 0.42,
  },
  windsong: {
    family: "WindSong",
    google: "WindSong",
    fallback: "cursive",
    ttfUrl: `${GF}/ofl/windsong/WindSong-Regular.ttf`,
    widthFactor: 0.52,
  },
  hurricane: {
    family: "Hurricane",
    google: "Hurricane",
    fallback: "cursive",
    ttfUrl: `${GF}/ofl/hurricane/Hurricane-Regular.ttf`,
    widthFactor: 0.46,
  },
  "fleur-de-leah": {
    family: "Fleur De Leah",
    google: "Fleur+De+Leah",
    fallback: "cursive",
    ttfUrl: `${GF}/ofl/fleurdeleah/FleurDeLeah-Regular.ttf`,
    widthFactor: 0.48,
  },
  "imperial-script": {
    family: "Imperial Script",
    google: "Imperial+Script",
    fallback: "cursive",
    ttfUrl: `${GF}/ofl/imperialscript/ImperialScript-Regular.ttf`,
    widthFactor: 0.46,
  },
  whisper: {
    family: "Whisper",
    google: "Whisper",
    fallback: "cursive",
    ttfUrl: `${GF}/ofl/whisper/Whisper-Regular.ttf`,
    widthFactor: 0.45,
  },
  bellefair: {
    family: "Bellefair",
    google: "Bellefair",
    fallback: "Georgia, serif",
    ttfUrl: `${GF}/ofl/bellefair/Bellefair-Regular.ttf`,
    widthFactor: 0.52,
  },
  "crimson-text": {
    family: "Crimson Text",
    google: "Crimson+Text",
    fallback: "Georgia, serif",
    ttfUrl: `${GF}/ofl/crimsontext/CrimsonText-Regular.ttf`,
    widthFactor: 0.52,
  },
  "julius-sans-one": {
    ...
    fallback: "Arial, sans-serif",
    ttfUrl: `${GF}/ofl/juliussansone/JuliusSansOne-Regular.ttf`,
    widthFactor: 0.6,
  },
  forum: {
    family: "Forum",
    google: "Forum",
    fallback: "Georgia, serif",
    ttfUrl: `${GF}/ofl/forum/Forum-Regular.ttf`,
    widthFactor: 0.52,
  },
  "gfs-didot": {
    family: "GFS Didot",
    google: "GFS+Didot",
    fallback: "Georgia, serif",
    ttfUrl: `${GF}/ofl/gfsdidot/GFSDidot-Regular.ttf`,
    widthFactor: 0.5,
  },
  "poiret-one": {
    family: "Poiret One",
    google: "Poiret+One",
    fallback: "Arial, sans-serif",
    ttfUrl: `${GF}/ofl/poiretone/PoiretOne-Regular.ttf`,
    widthFactor: 0.58,
  },
  "tenor-sans": {
    family: "Tenor Sans",
    google: "Tenor+Sans",
    fallback: "Arial, sans-serif",
    ttfUrl: `${GF}/ofl/tenorsans/TenorSans-Regular.ttf`,
    widthFactor: 0.58,
  },
  "sorts-mill-goudy": {
    ...
    fallback: "Georgia, serif",
    ttfUrl: `${GF}/ofl/sortsmillgoudy/SortsMillGoudy-Regular.ttf`,
    widthFactor: 0.5,
  },
  "spectral-light": {
    family: "Spectral",
    google: "Spectral",
    fallback: "Georgia, serif",
    ttfUrl: `${GF}/ofl/spectral/Spectral-Light.ttf`,
    weight: 300,
    widthFactor: 0.52,
  },
  playfair: {
